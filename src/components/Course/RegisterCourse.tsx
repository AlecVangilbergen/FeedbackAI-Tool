...
const RegisterCourse: React.FC = () => {
  ...
  return (
    <div className="p-6 bg-light-neutral dark:bg-dark-neutral">
      <h2 className="text-xl font-bold mb-4 text-light-text dark:text-dark-text ">Register Course</h2>
      {success ? (
        ...
        <form onSubmit={handleSubmit}>
          ...
          <div className="mb-4 text-light-text dark:text-dark-text">
            <label className="block text-sm font-bold mb-2 text-light-text dark:text-dark-text" htmlFor="teacher_id">
              Teacher
            </label>
            <select
              id="teacher_id"
